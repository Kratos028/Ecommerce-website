...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<c:url value="/resources/images/24-05-2018-1.jpg"/>" alt="First slide" style=" width:1345px height:592px;">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<c:url value="/resources/images/Apple_TV_4k.png"/>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<c:url value="/resources/images/Features-Loaded-Electronics-eCommerce-Platform-For-your-Online-Store-1.jpg"/>" alt="Third slide">
    </div>
  </div>
